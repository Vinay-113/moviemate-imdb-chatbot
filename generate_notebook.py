    ...
    return {
        "cells": [
            ...
            markdown_cell(
                ...
                "director, and overview text. When configured with `OPENAI_API_KEY`, it can also use the "
                "OpenAI Responses API for natural-language replies and OpenAI embeddings for semantic retrieval. "
                "Follow-up messages can refine the prior query state, and the app stores a lightweight user "
